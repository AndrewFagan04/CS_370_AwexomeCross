...
menu_music = join('Cycle_3/audio', 'menuMusic.wav')
cutsceneAudioPath = join('Cycle_3/audio', 'AwexomeCrossIntroAudio.wav')
cutsceneAudio = pygame.mixer.Sound(cutsceneAudioPath)
bgmAudioPath = join('Cycle_3/audio', 'bgm.mp3')
bgmAudio = pygame.mixer.Sound(bgmAudioPath)

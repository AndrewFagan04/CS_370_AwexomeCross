...
backgroundW = pygame.image.load(join("_internal/sprites","AwexomeCrossTitleScreenY.png"))
backgroundY = pygame.image.load(join("_internal/sprites","AwexomeCrossTitleScreenW.png"))
backgroundS = pygame.image.load(join("_internal/sprites","space.png"))
moon = pygame.image.load(join("_internal/sprites","8-bitMoonEND.png"))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if play_button.is_clicked(event.pos):
                    cutscene(join('_internal',"testvideo.mp4"), window)
                    game_loop()
...
def cutscene(video_path, window):
    ...
    cap = cv2.VideoCapture(join('_internal',"AwexomeCrossIntroCOMPETED.mp4"))
